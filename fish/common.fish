...
#path
set PATH /usr/local/bin /usr/bin /bin /usr/sbin /sbin /opt/X11/bin ~/.anyenv/bin $GOPATH/bin /Users/hiramekun/Library/Android/sdk/platform-tools /Users/hiramekun/.local
alias g++="g++-8"
alias gcc="gcc-8"
